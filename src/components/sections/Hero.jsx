      ...
      <div id="home" className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        >
          ...
          <div className="flex flex-col justify-center flex-1 px-8 md:px-12 pt-32 pb-0">
            ...
            >
              ...
              <span
                className="text-blue-200 text-xs font-bold tracking-widest"
            ...
            {/* Heading */}
            <h1
              className={`hero-reveal ${show ? "active" : ""} delay-2`}
            ...
            >
              <span
                ...
                style={{
                  ...
                  fontSize: "clamp(40px,5.2vw,40px)",
                }}
              >
                Professional Tile Fitting                 Flooring Installation in Mumbai
            ...
            {/* Divider */}
            <div
              className={`hero-reveal ${show ? "active" : ""} delay-3
            ...
            <p
              className={`hero-reveal ${show ? "active" : ""} delay-3
              text-blue-200 leading-relaxed mb-8 max-w-lg`}
              style={{
            ...
            >
              Since 1999, Gunatit Enterprise has delivered expert tile fitting and flooring installation services for residential, commercial, and institutional projects across Mumbai.
            </p>

            {/* CTA Buttons */}
            <div
              className={`hero-reveal ${show ? "active" : ""} delay-4
            ...
            {/* Service Tags */}
            <div
              className={`hero-reveal ${show ? "active" : ""} delay-5
        ...
        <div
          ...
          style={{
            background: "#f0f5ff",
            backgroundImage:
              "radial-gradient(circle, #c7d7f8 1px, transparent 1px)",
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              height: "68%",
              background:
                "radial-gradient(ellipse at center, rgba(147,197,253,.22) 0%, transparent 70%)",
            }}
          />

          {/* Illustration */}
          <div
            className={`hero-reveal-l ${show ? "active" : ""} delay-6
